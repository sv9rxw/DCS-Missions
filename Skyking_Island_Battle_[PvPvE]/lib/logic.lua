...
if not Group.getByName(BLUE_PREDATOR_GROUP_NAME) then
    if BLUE_PREDATOR_RESPAWN_TIMES_I < BLUE_PREDATOR_RESPAWN_TIMES_MAX then
        ...
        msg = "SKYKING, SKYKING. INFO MESSAGE: Our AFAC Predator has been taken down. New UAV Predator is airborne. " .. BLUE_PREDATOR_RESPAWN_TIMES_MAX - BLUE_PREDATOR_RESPAWN_TIMES_I .. " units remaining. Skyking, Skyking. Out."
...
if not Group.getByName(RED_PREDATOR_GROUP_NAME) then
    if RED_PRDATOR_RESPAWN_TIMES_I < RED_PREDATOR_RESPAWN_TIMES_MAX then
        ...
        msg = "SKYKING, SKYKING. INFO MESSAGE: Our AFAC Predator has been taken down. New UAV Predator is airborne. " .. RED_PREDATOR_RESPAWN_TIMES_MAX - RED_PRDATOR_RESPAWN_TIMES_I .. " units remaining. Skyking, Skyking. Out."
        trigger.action.outTextForCoalition(coalition.side.RED, msg, 30)
    end
end
---------------------------------------------------------------------------